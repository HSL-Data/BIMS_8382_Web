...
View(filter(gm, year == 1992))

View(filter(gm, population > 20000000 & year == 1992))
...
p <- ggplot(gm, aes(x = continent, y = lifeexp))
p
...
p + geom_violin()
  p + 
    geom_violin() + 
    geom_jitter(aes(color = continent), alpha = 1/4)
...
p <- ggplot(gm, aes(x = reorder(continent, population), y = lifeexp))
p 
p + geom_boxplot()

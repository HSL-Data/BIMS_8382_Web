...
PCA stands for *Principal Components*. It is a technique that results in features called Principal Components (PCs) that are a linear combination of our predictors.
